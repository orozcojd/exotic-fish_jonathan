    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                String sql = "SELECT name, price, fish_type, sci_name, "
                        + "description, slide1,"
                ...
                while(rs.next()){
                    ...
                    if (loopCheck == 0) {
                        ...
                        //Jonathan's product list
                        lastViewed lastV;
                        HttpSession session = request.getSession();
                        lastV = (lastViewed) session.getAttribute("lastViewed");
                        totalProducts = lastV.size;
                        p.name = rs.getString("name");
                        p.img = "img/" + rs.getString("name") + "1";
                        ...
                        if(totalProducts == 0){
                            ...
                            {
                                if(lastV.fiveProducts.get(i).sci_name.equals(p.sci_name))
                                {
                                    inArray = true;
                                }
                            }
