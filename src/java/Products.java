...
//        if(lastV.fiveProducts.size() > 0){
        ...
        out.print("<table style=' margin-top:2em;color:white; text-align:center; font-family:Arial,Helvetica, sans-serif; width:100%'>" 
            ...
            out.print("<div class='right' style='position:relative; color: #c0fff4; text-shadow: 1px 1px #000000;\n" +
"        text-align: center; \n" +
"        font-size: 50px;\n" +
"        font-family: Playfair Display, serif; '>"
                         + "Recently Viewed </div> ");
             for (Products i: lastV.fiveProducts) {
                 out.print("<td ><a href=" + "http://andromeda-16.ics.uci.edu:8406/exotic-fish/ProductDetails?pid="
                         + Integer.toString(count) +"><img src=" + "'" + Products.imgSrc(i.name,1) + "'" + " alt ="
                        + "'" + i.name + "1'" + "/></a></td>");
                 ++count;
             }
             out.print("</tr>");
             out.print("<tr class ='spaceUnder2 '>");
              for (Products i: lastV.fiveProducts) {
                  out.print("<td style= 'height:30px'>" + i.name+ 
                          "<br> Price: $" + i.price+ " </td>");  
              }
              out.print("</tr>  </table> ");
         //}
...
"    </tr>");
        ...
        for (i = 0; i < 3; i++) {
            ...
            for (int j = 0 ; j < 4; j++) {
               ...
               out.print("<td ><a href=" + "http://andromeda-16.ics.uci.edu:8406/exotic-fish/ProductDetails?pid="
                         + Integer.toString(count) +"><img src=" + "'" + Products.imgSrc(fish.name,1) + "'" + " alt ="
                        + "'" + fish.name + "1'" + "/></a></td>");
               ++count;
            }
            // </tr>
